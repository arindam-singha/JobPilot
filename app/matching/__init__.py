...
def tokenize_matching_text(value: str) -> set[str]:
    """Return normalized tokens suitable for deterministic comparison."""
...
def contains_normalized_phrase(
    ...
    """Return whether candidate text contains the normalized requirement."""
...
def token_coverage(
    ...
    """Return the proportion of requirement tokens found in candidate text."""
...
def combine_evidence_text(
    ...
    """Combine non-empty evidence fields into one searchable string."""
